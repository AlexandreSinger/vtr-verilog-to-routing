...
struct t_heap_path {
    ...
    double backward_delay = 0.;
    double backward_cong = 0.;
};
...
class PathManager {
  public:
    ...
    void insert_backwards_path_into_traceback(t_heap_path* path_data, double cost, double backward_path_cost, RoutingContext& route_ctx);
