...
// #define VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_ARRAY
...
#    if defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP) || defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_FIRST_INDEX_ZERO) || defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_ELEM) || defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_ELEM_LARGE) || defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_ARRAY) || defined(VPR_ROUTER_USE_CUSTOMIZED_FOUR_ARY_HEAP_FINAL)
