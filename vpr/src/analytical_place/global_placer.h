...
private:
    ...
    /// @brief The target gap between the HPWL of the upper-bound and lower-
    ///        bound placements. The placer will stop if the gap is smaller
    ///        than this number.
    static constexpr double target_hpwl_gap_ = 100.0;
